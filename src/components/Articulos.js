export let productos = [   
    ...
    {id:"4", 
     ...
     categoria: "perros",
     description:"Colchon XL para mascotas grandes. Completamente de algodon. Hipoalergenico.", 
     price:"$9000", 
     pictureUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZ3Oofn7SVNU76A4ZDUDOnKa5jSaONMKMsjA&usqp=CAU"}
     ,
    {id:"5", 
     title:"Rascador para Gatos",
     categoria: "gatos", 
     description:"Juguete para gatos de 50cm de largo. De gran resistencia y duradero.", 
     price:"$2000", 
     pictureUrl:"https://animall.com.ar/5364/rascador-para-gatos-forma-de-onda-con-hierba-gatera.jpg"}
     ,
    {id:"6", 
